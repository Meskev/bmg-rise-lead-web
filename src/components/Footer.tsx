...
const Footer = () => {
  return (
    <footer className="bg-bmg-navy text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-bmg-orange transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 font-open-sans">
              <li><Link to="/about" className="text-gray-300 hover:text-bmg-orange transition-colors">About Us</Link></li>
              <li><Link to="/services" className="text-gray-300 hover:text-bmg-orange transition-colors">Services</Link></li>
              <li><Link to="/ventures" className="text-gray-300 hover:text-bmg-orange transition-colors">Ventures</Link></li>
              <li><Link to="/contact" className="text-gray-300 hover:text-bmg-orange transition-colors">Contact</Link></li>
            </ul>
          </div>
